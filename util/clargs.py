...
class clargs(self, offset=0):
	...
	commands. It's different from both *nix and Windows command line
	formats, but should facilitate both. 
	...
	def parse (self, text):
		...
		return dict('args':args, 'kwargs':kwargs, 'flags':flags)
