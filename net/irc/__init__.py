...
class IRCEvent(object):
	"""
	Parse information from the IRC server into member variables.
	"""
	...
	def __init__(self, line_text):
		"""
		Parses a line of text received from the IRC server. Separates 
		any line into the following member variables:
		
		line   : full line as received
		orig   : text portion of line
