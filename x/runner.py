...
class Runner(EncodingHelper):
	...
	def __init__(self, config=None, **k):
		...
		defaultinterrupt = False if self.__csock else True
		self.__interrupt = bool(config.get('interrupt',defaultinterrupt))
	...
	@property
	def interrupt(self):
		"""If False, KeyboardInterrupt is captured."""
